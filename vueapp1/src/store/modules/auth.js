...
import {preciseTimeLeft, humanReadableTimeApprox} from '../..//helpers/extraLogics'
...
const getters = {
    ...
    */
    ...
    getCreateTicketStatus(state) { // Add this getter
        return state.create_ticket;
    },
    getStatusText: (state) => {
...
const mutations = {
    ...
    */
    ...
    setCreateTicketStatus(state, status) { // Add this mutation
        state.create_ticket = status;
    },
...
const actions = {
    ...
    setCreateTicket({ commit }, status) { // Add this action
        commit('setCreateTicketStatus', parseInt(status));
    },
    updateStatusText({ commit }, text) {
        commit('setStatusText', text);
    }
};
